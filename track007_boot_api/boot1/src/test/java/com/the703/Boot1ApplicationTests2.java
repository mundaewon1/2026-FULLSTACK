...
class Boot1ApplicationTests2 {
	...
	@Disabled @Test public void deleteService_User(){
		...
		user.setEmail("2@2");   user.setPassword("2");   user.setAppUserId(42);
	...
	@Disabled @Test public void updateService_User(){
		...
		user.setProvider("local"); user.setProviderId("local_002"); user.setAppUserId(42);
	...
	@Disabled @Test public void insertService_User(){
		AppUserDto user = new AppUserDto();
		user.setEmail("2@2");      user.setPassword("2"); user.setMbtiTypeId(1);
	...
	////////////////////////////////////////////
	//6. 수정 ( 동적sql )
	@Disabled @Test public void edit_User(){
		AppUserDto user = new AppUserDto();
		user.setAppUserId(41);
