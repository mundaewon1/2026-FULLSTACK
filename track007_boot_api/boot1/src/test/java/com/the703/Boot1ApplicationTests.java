...
class Boot1ApplicationTests {
	...
	@Test public void test10_delete() {
	 ...
	 @Disabled @Test public void test09_update() {
		...
		dto.setBpass("1111"); dto.setId(21);
	...
	@Disabled @Test public void test08_detail() {
		Sboard2Dto dto = new Sboard2Dto();
		dto.setId(21);
		assertEquals(21, sboard2Service.detail(dto).getId());
	}
	@Disabled @Test public void test07_service_paging() { //페이징, 갯수
		assertEquals(2, sboard2Service.list10(1).size());
		
		assertEquals(2, sboard2Service.selectCnt());
	}
	...
	@Disabled @Test public void test05_delete() { //삭제
		Sboard2Dto dto = new Sboard2Dto(); dto.setId(3);
		System.out.println(sboard2Dao.delete(dto));
		int result = sboard2Dao.delete(dto);
		assertEquals(3, result);
	}
	@Disabled @Test public void test04_update() { //수정
		Sboard2Dto dto = new Sboard2Dto(); dto.setId(4);
	...
	@Disabled @Test public void test02_paging() { //페이징, 갯수
		...
		assertEquals(1, list10.size()); // 1숫자는 지금 있는 list 개수 (예상되는 결과, 해당코드)
		assertNotNull(list10);

		assertEquals(1, sboard2Dao.selectCnt()); // 전체갯수 1개
	}
