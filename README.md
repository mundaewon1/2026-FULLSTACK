...
비전공자로 시작해 6개월 동안 **Java, Spring, React, Database, AWS** 등 웹 개발 전반을 단계적으로 학습했습니다.  개인 학습을 넘어 다양한 프로젝트와 팀 프로젝트를 진행하며 **프론트엔드부터 백엔드, 데이터베이스, 배포까지 하나의 서비스가 동작하는 흐름**을 경험했습니다.

특히 기능을 구현하는 것에 그치지 않고, 오류가 발생했을 때 **요청 → 서버 → DB의 흐름을 따라가며 원인을 찾고 해결하는 과정**을 중요하게 생각하고 있습니다.

기본기를 바탕으로 꾸준히 배우고, **문제를 스스로 발견하고 해결할 수 있는 개발자**로 성장하겠습니다.
