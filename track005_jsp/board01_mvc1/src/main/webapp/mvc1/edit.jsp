...
%>
   <div class="container card my-5">
      <h3 class="card-header">글 수정</h3>
       ...
       <form action="edit_action.jsp?bno=<%=bno%>" method="post" onsubmit="return ck()">
       <div class="my-3">
       ...
       <div class="my-3">
	       ...
	       <textarea type="text" class="form-control" id="bcontent" name="bcontent"><%=bcontent%></textarea>
	   </div>
       <div class="my-3 text-end">
           <button type="submit"   class="btn btn-outline-primary"  title="글수정">수정</button>
           <a href="list.jsp"             class="btn btn-outline-success"  title="취소">취소</a>
           <button type="reset"  class="btn btn-primary"  title="목록보기">목록보기</button>
       </div>
       </form>
