...
<body>
	...
	<div class="container my-4">
		<h2>회원가입</h2>
			<form action="join_action.jsp" method="get" onsubmit="return ck()">
				<div class="my-3">
		...
		function ck(){
			...
			if(nickname.value.trim()==""){ alert("닉네임을 확인해주세요"); nickname.focus(); return false; }
			...
			if(mobile.value.trim()==""){ alert("휴대폰번호를 확인해주세요"); mobile.focus(); return false; }
			return true;
		};
		</script>
