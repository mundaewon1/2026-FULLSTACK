...
<body>
	<div class="container card  my-5">
		...
		<pre class="alert alert-warning"> 
			반갑습니다.  <%=session.getAttribute("email")%> 님 </pre>
		...
		<script>
	  	function checkLogin(){
			...
			let pass = document.getElementById("pass");
	  		...
	  		if(email.value.trim() == ""){ alert("email를 입력해주세요"); email.focus(); return false; }
			if(bpass.value.trim() == "") { alert("password를 입력해주세요"); bpass.focus(); return false; }
	  		return true;
	  	}
