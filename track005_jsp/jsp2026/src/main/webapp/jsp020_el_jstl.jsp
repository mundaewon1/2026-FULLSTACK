...
<body>
   <div class="container card my-5">
      ...
      <p> <a href="jsp020_result.jsp?name=sally"  class="btn btn-info">PARAM - 데이터 넘기기</a></p>
      ...
      <h4 class="card_header">1) if</h4>
      <c:if test="${10>3}">  10은 3보다 크다 </c:if>
      
      <h4 class="card_header">2) choose</h4>
      ...
      <h4 class="card_header">3) forEach</h4>
