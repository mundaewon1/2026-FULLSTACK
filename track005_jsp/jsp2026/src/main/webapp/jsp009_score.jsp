...
<body>
	<div class="container card  my-5">
		...
		<form  action="jsp009_result.jsp"  method="get" onsubmit="return ck()">
			<div class="my-3">
		...
		function ck(){
			...
			if(kor.value.trim()==""){alert("국어점수 확인"); kor.focus(); return false;}
			if(eng.value.trim()==""){alert("영어점수 확인"); eng.focus(); return false;}
			if(math.value.trim()==""){alert("수학점수 확인"); math.focus(); return false;}
			return true;
		}
		</script>
	</div>
