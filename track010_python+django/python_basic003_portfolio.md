...
# Django      : 통계수집, Rest api, pandas 데이터 분석/시각화
...
# 답: 메인 서비스의 ( db 부하 )를 분산시키고, 파이썬의 강력한 ( pandas ) 생태계를 활용하기 위함
...
<body>
    <div class="dashboard-container">
        ...
        <div class="summary-cards">
            <div class="card">
                <h4>최다 발생 카테고리</h4>
                <p style="color: #2b6cb0;">{{ ____________________ }}</p>
            </div>
            <div class="card">
                <h4>평균 건수</h4>
                <p>{{ stats_summary.____________________ }}개</p>
            </div>
            <div class="card">
                <h4>최대 건수</h4>
                <p>{{ stats_summary.____________________ }}개</p>
    ...
    {{ categories|____________________:"categories-data" }}
    {{ visitors|____________________:"visitors-data" }}
    {{ sales|____________________:"sales-data" }}
    {{ shares|____________________:"shares-data" }}
...
```java
// 💡 [필기] /api/statistics 경로에 대해 인증 없이 접근을 허용하는 Security 메서드는?  permitAll()
@Bean
