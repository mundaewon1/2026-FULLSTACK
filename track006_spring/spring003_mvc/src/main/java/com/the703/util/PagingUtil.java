...
public class PagingUtil {
   ...
   private  int  pagetotal;    //#3) 총페이지수 256/10 = 26 페이지
   ...
   public PagingUtil(int listtotal, int pstartno) {  //전체페이지수, 시작하는 번호 1 2 3 4 5 6 ,,,,
		...
		this.onepagelist = 10;		 // 한페이지에 보여줄 개시물의 수
