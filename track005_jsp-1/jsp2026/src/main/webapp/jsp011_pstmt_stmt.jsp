...
<body>
   <div class="container card my-5">
      ...
      3) Connection DB연동
      4) Statement, PrepareStatement sql 구문실행
      ...
      try{
      	...
      	if(conn != null){ out.println("db 연동"); conn.close();}
      ...
      try{
        ...
        rset = pstmt.executeQuery();	//표 executeQuery- select / executeUpdate- insert, updete, delete,  실행한 줄 수
