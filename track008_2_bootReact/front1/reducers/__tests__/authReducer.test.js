...
describe('user slice reducer' , ()=>{
    ...
    it('signupFailure' , ()=>{
        ...
        // 2. 리듀서툴킷에서 { type:signupFailure , payload:'회원가입 실패' } 객체만들기
    ...
    it('fetchUserSuccess' , ()=>{     
        ...
        // 1. fetchUserSuccess(userData) 실행하면  - {id:1 , email:'1@1'};
        // 2. 리듀서툴킷에서 { type:fetchUserSuccess , payload:userData } 객체만들기
    ...
    it('resetUserState' , ()=>{      
        ...
        // 2. 리듀서툴킷에서 { type:resetUserState , payload:undefined } 객체만들기
