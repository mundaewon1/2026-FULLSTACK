...
public class UserController {
	...
	private final UserService  userService;  //@Authwired
	...
	// 닉네임중복확인	
	@Operation( summary="닉네임 중복 확인" , description = "사용 닉네임인지 중복 여부를 확인합니다.")
	...
	public    ResponseEntity<UserResponseDto>  updateProfileImage(
			@Parameter(description = "사용자 ID")    @PathVariable("userId") Long userId,
			@Parameter(description = "업로드할 프로필 이미지")  @RequestParam("ufile") MultipartFile ufile
	){
