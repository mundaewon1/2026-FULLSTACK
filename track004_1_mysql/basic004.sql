...
desc userinfo;
insert into userinfo (name, age) values ( 'bbb' , 11); -- o
insert into userinfo (name, age) values ( 22 , 'bbb'); -- x
-- 10:42:07	insert into userinfo (name, age) values ( 22 , 'bbb')	
-- Error Code: 1366. Incorrect integer value: 'bbb' for column 'age' at row 1	0.000 sec
insert into userinfo (age, name) values ( 33 , 'bbb'); -- o
...
insert into emp values (7521,'ARD','SALESMAN',7698,'1981-02-22',1250,500,30);
insert into emp values (7566,'JONES','MANAGER',7839,'1981-04-02',2975,NULL,20);
insert into emp values (7654,'MARTIN','SALESMAN',7698,'1981-09-28',1250,1400,30);
insert into emp values (7698,'BLAKE','MANAGER',7839,'1981-05-01',2850,NULL,30);
insert into emp values (7782,'CLARK','MANAGER',839,'1981-06-09',2450,NULL,10);
...
insert into salgrade(losal,hisal) value(700,1200);
insert into salgrade(losal,hisal) value(1201,1400);
insert into salgrade(losal,hisal) value(1401,2000);
insert into salgrade(losal,hisal) value(2001,3000);
insert into salgrade(losal,hisal) value(3001,9999);
...
insert into userinfo value (2,'second',22);
insert into userinfo value (3,'third',33);
insert into userinfo value (4,'fourth',44);
...
insert into score(sno,sname,sjava,sjsp,sspring,sproject,sstotal,ssavg,semail) value(3,'ccc',70,20,78,80,null,null,null);
...
-- [006]  이름이 bbb인 학생의 sjava 점수를 92 , sjsp점수를 78로 , 총점, 평균을  수정하시오
 update score set sjava=92, sjsp=78, sstotal=sjava+sjsp+sspring+sproject where sname='bbb';
...
-- [010]   ssavg이89.5이고 sproject가 98인 학생의 semail을  hello@gmail.com으로 수정하시오
 update score set semail='hello@gmail.com' where ssavg=83 and sproject=98;
...
select * from emp;
update delete_emp set job='CLERK' where mgr=7782;
