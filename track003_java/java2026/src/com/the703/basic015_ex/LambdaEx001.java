...
//    	익명 객체로 "Message: <문자열>" 형식으로 출력하기 Message: Hello World
//    	람다식으로 동일한 기능 구현하기 Message: Lambda Rocks!
    		...
    		//p2.print("Lambda Rocks!");
	    		Printer p2 = msg -> System.out.println("Message2: "+msg);
	    		p2.print("Lambda Rocks!");
	    	...
	    	System.out.println("람다식 결과2: " + c2.add(10, 20));
	    	
            //System.out.println("익명객체 결과: " + c1.add(3, 5));  익명객체 결과: 8
            //System.out.println("람다식 결과: " + c2.add(10, 20));  람다식 결과: 30
    }
}
