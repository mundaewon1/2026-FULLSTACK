...
//class Son extends Papa, Mama{} 자바에서의 클래스 상속은 단일상속

interface Animal2{
	String company="(주) 메가스터디";	
	//sf : static final  - Animal2.company (클래스변수) method area, new x, this x
...
1) abstract  - 인스턴스변수, 일반메서드, 추상메서드 둘다 가질수 있으나
