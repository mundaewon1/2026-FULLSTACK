...
public class Network003_book {
	public static void main(String[] args) {
		try {
			...
			//			Client ID		MLiWrShHwDCNj4zkCkLZ
			//			Client Secret	cInZL_40W9
			conn.setRequestMethod("GET");
			conn.setRequestProperty("X-Naver-Client-Id"		, "MLiWrShHwDCNj4zkCkLZ");
			conn.setRequestProperty("X-Naver-Client-Secret"	, "cInZL_40W9");
