...
public class Lambda002 {
	public static void main(String[] args) {
		...
		InterA2 a3 = ()->  System.out.println("hi hi hi");    a3.hi(); // 처리할일이 한줄 {}생략가능
		...
		//2-2.  람다식  ()->{}
		InterB2 b2 = (String name)->{ System.out.println("hihi! " + name);};	b2.hi("sally");

		InterB2 b3 = (name)		  ->{ System.out.println("hihihi! " + name);};	b3.hi("sally");

		InterB2 b4 = name		  ->  System.out.println("hihihihi! " + name);	b4.hi("sally");
		...
		//3-2.  람다식  ()->{}
		InterC2 c2 = ()	->	{return "Good :Day2";}; System.out.println( c2.hi() );
		InterC2 c3 = ()	->	"Good :Day3"; 			System.out.println( c3.hi() );
		...
		InterD2 d1 = new InterD2() {
			...
			System.out.println(d1.hi( 1, "sally" ));  //hi sally ★ 		별의 개수, 이름
			System.out.println(d1.hi( 2, "sally" ));  //hi sally ★★  
		//4-2. 람다식  ()->{}  
		InterD2 d2 = ( num, name)->{String star="";
			for(int i=0; i<num; i++) { star+= "★";}
			return "hi " + name + star;};
