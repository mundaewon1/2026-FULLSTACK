...
public class Method003 {
	...
	//1. 함수구조 public static 리턴값(결과물) 메서드명(마법상자이름) ( 파라미터:재료 ) { 할일 }
	...
	public static double		spell(double num) {return num/2.0; }
	...
	public static void main(String[] args) {
		...
		// public static 리턴값		메서드명(파라미터){ 해야할일 }
		// public static double		spell(double num) {return num/2; }
