...
public class Set001 {
	public static void main(String[] args) {
		...
		System.out.println(set2.remove(new Candy("춥파춥스", 200))? "냠냠~!" : "못먹었어!");
...
class Candy{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Candy other = (Candy) obj; return Objects.equals(name, other.name) && price == other.price; }
