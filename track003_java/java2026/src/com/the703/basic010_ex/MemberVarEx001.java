...
[METHOD:정보]	Sawon3.class	MemberVarEx001 #1
	Sawon3.su=10;	Sawon3.basicpay2;		Sawon3.basicpay;	Sawon3.showSu()		Sawon3.showAll02()
------------------------------------------------------------------------------------------------------------
[HEAP:동적]            		|  [STACK:지역]
...
class Sawon3{ 
    ...
    // static int basicpay=pay; //3) 클래스변수 - 인스턴스변수 - static 은 인스턴스 변수 불가 사용할때 구동시작점이 다름
